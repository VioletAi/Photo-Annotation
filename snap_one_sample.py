...
def capture_one_image(scene_id, annotated_camera, instance_attribute_file, image_width, image_height, save_path):
    ...
    pose_database = f"/home/wa285/rds/hpc-work/Thesis/download_intinsic_matrix/images_and_pose/{scene_id}/pose"
    similar_file,photo_extrinsic= find_most_similar_matrix(view_matrix, pose_database)
    similar_file=similar_file[:-4]
    print(photo_extrinsic)
    # import pdb
    # pdb.set_trace()
    ...
    photo_path = f'/home/wa285/rds/hpc-work/Thesis/download_intinsic_matrix/images_and_pose/{scene_id}/color/{similar_file}.jpg'  # Specify the path to your image
    ...
    for idx, loc in enumerate(locs):
        ...
        if idx in visible_idx:
            if objects[idx] in ["wall", "ceiling", "floor", "object", "item"]:
                continue
